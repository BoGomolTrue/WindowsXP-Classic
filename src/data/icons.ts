...
export const DESKTOP_ICONS: DesktopIcon[] = [
  ...
  { id: 'recycle-bin', label: 'Корзина', icon: 'icon-recycle', x: 6, y: 231, kind: 'system', system: true },
  { id: 'ie', label: 'Internet Explorer', icon: 'icon-ie', x: 6, y: 306, kind: 'system', system: true },
  { id: 'telegram', label: 'Telegram', icon: '/Telegram_2019_Logo.svg.webp', x: 81, y: 6, kind: 'system', system: true, target: 'app:telegram' },
]
